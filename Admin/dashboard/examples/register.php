          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="../examples/register.php">
                ...
                <span class="nav-link-inner--text">Add User</span>
              </a>
            </li>
            <li class="nav-item">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">Welcome Aslı!</h1>
            </div>
          </div>
        </div>
      </div>
              ...
              <form role="form" method="post" action="">
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" placeholder="Full Name" type="text" required name="fullName">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary mt-4" name="add-user">Register User</button>
                </div>
              </form>
              <!-- ************************* end ************************** -->
            </div>
