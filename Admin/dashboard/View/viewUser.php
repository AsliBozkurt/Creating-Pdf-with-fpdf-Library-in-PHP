        ...
        <!-- ********************************* -->
            ...
            <table class="table table-striped table-hover" >
                <thead>
                  ...
                  ?> 
                    <tr><button type="submit" name="create_user_pdf" class="btn btn-info"><a href="aga/create_user_pdf.php" target="_blank">Create a PDF</a></button></tr>  
                </thead>
                <tbody>
                  <!-- -------------------------------------- -->
                  <?php 
                  ...
                  ?>
                          <tr>
                            ...
                            <td>
                                Add as 
                                <button class="btn btn-light"><a href="../AddUser/addAdmin.php?add-admin=<?php echo $row[$i]['user_id'] ?>">Admin</a></button>
                                <button class="btn btn-light"><a href="../AddUser/addTeacher.php?add-teacher=<?php echo $row[$i]['user_id'] ?>">Teacher</a></button>
                                <button class="btn btn-light"><a href="../AddUser/addStudent.php?add-student=<?php echo $row[$i]['user_id'] ?>">Student</a></button>
                            </td>
                        </tr>
                  <?php } ?>
                    <!-- ------------------------------------- -->
