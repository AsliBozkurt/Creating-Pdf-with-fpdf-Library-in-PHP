                ...
                <?php 
                  ...
                  ?>
                          <tr>
                            ...
                            <td><?php echo $row[$i]['ogrenci_tc'] ?></td>
                            <td><?php echo $row[$i]['ogrenci_bolumm_adi'] ?></td>
                            <td>
                            <td>
                              <button class="btn btn-light"><a href="../Info/StudentInfo.php?view-student=<?php echo $row[$i]['kullanci_id']  ?>">View</a></button>
                            </td>
                          </tr>
                <?php } } ?>
                </tbody>
                 ...
                 <?php
                  ...
                  {
                    $kullanci_id=$row['kullanci_id'];
                    $ogrenci_ad_soyad=$row['ogrenci_ad_soyad'];
                    $ogrenci_okul_no=$row['ogrenci_okul_no'];
                    $ogrenci_fakulte_adi=$row['ogrenci_fakulte_adi'];

                  }

                  ?> 
                  <tr><button type="submit" name="create_student_pdf" class="btn btn-info"><a href="aga/create_student_pdf.php" target="_blank">Create a PDF</a></button></tr>  
            </table>
            </div>
        <!-- ********************************* -->
    </div>
