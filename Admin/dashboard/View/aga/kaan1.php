        ...
        <div class="card">
            ...
            <!-- ------------------- starting of internship form ------------->
                <form method="post" action="conver_pdf.php">
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" name="student_email" type="email" placeholder="Mail Adresi"  required>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <h4 style="text-align:right;" class="mt-3">Tarih: <?php echo date("Y-m-d");?></h4>
                    ...
                    //  $connection = mysqli_connect('localhost','root','','yazgeldb');
                     ...
                     // mysqli_query($connection, $sql);
                      //$result=$connection->prepare($mysqli_query);
                      //$result->execute();
                    ?>
