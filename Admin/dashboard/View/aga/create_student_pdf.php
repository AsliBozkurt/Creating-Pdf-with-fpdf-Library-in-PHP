...
$pdf->Cell(80);
$pdf->Cell(30,5,"OGRENCI LISTESI",0,1,"C");
$pdf->Cell(160);
...
while($row=mysqli_fetch_assoc($result)){
    ...
    $pdf->Cell(50,10,$row['ogrenci_ad_soyad'],1,0,"L");
    $pdf->Cell(50,10,$row['ogrenci_okul_no'],1,0,"L");
    $pdf->Cell(70,10,$row['ogrenci_fakulte_adi'],1,1,"L");
    $i++;
