...
if($_GET['view-commission']){

  $teacher_id = $_GET['view-commission'];
          ...
          <div class="card bg-secondary shadow">
            ...
            <form method="POST" action="process/crud_commission.php">
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <button type="submit" name="update_teacher_info" value="<?php echo $teacher_id  ?>" class="btn btn-primary">Update</button>
                      <button type="submit" name="remove_from_commission" value="<?php echo $teacher_id  ?>" class="btn btn-warning">Remove From Commission</button>
                      <button type="submit" name="remove_teacher" value="<?php echo $teacher_id  ?>" class="btn btn-danger">Remove</button>
                    </div>
                  </div>
                </div>
              </form>
