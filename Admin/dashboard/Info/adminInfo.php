                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="admin_full_name" class="form-control form-control-alternative" placeholder="Full Name" value="<?php echo $fullName ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Email address</label>
                        <input type="email" name="admin_email" class="form-control form-control-alternative" placeholder="Email" value="<?php echo $email ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Password</label>
                        <input type="password" name="admin_password" class="form-control form-control-alternative" placeholder="password" value="<?php echo $password ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                    <!--  -->
                        <button type="submit" name="update_admin_info" value="<?php echo $admin_id  ?>" class="btn btn-primary">Update</button>
                        <button type="submit" name="remove_admin" value="<?php echo $admin_id  ?>" class="btn btn-danger">Remove</button>
                    </div>
                  </div>
                </div>
              </form>
