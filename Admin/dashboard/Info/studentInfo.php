      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Hello Aslı</h1>
          ...
          <div class="card bg-secondary shadow">
            ...
            <form method="post" action="process/crud_student.php">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="tc" class="form-control form-control-alternative" placeholder="1511XXXXXXX" value="<?php echo $tc; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Nationality</label>
                        <input type="text" name="nationality" class="form-control form-control-alternative" placeholder="Turkey" value="<?php echo $nationality; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Tel</label>
                        <input type="text" name="tel" class="form-control form-control-alternative" placeholder="+905XXXXXXXXX" value="<?php echo $tel; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Email Address</label>
                        <input type="email" name="email" class="form-control form-control-alternative" placeholder="example@gmail.com" value="<?php echo $email; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Password</label>
                        <input type="password" name="password" class="form-control form-control-alternative" placeholder="Password" value="<?php echo $password; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">University Name</label>
                        <input type="text" name="university" class="form-control form-control-alternative" placeholder="University" value="<?php echo $university; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Faculty</label>
                        <input type="text" name="faculty" class="form-control form-control-alternative" placeholder="Faculty Name" value="<?php echo $faculty; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Department</label>
                        <input type="text" name="department" class="form-control form-control-alternative" placeholder="Department" value="<?php echo $department; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Grade</label>
                        <input type="text" name="grade" class="form-control form-control-alternative" placeholder="Grade ex: 2" value="<?php echo $grade; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">University NO</label>
                        <input type="text" name="university_no" class="form-control form-control-alternative" placeholder="University NO" value="<?php echo $university_no; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Address</label>
                        <input type="text" name="address" class="form-control form-control-alternative" placeholder="Address" value="<?php echo $address; ?>" required>
                      </div>
                    </div>
                    <!-- **************************************************** -->
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                        <button type="submit" name="update_student_info" value="<?php echo $student_id  ?>" class="btn btn-primary">Update</button>
                        <button type="submit" name="remove_student" value="<?php echo $student_id  ?>" class="btn btn-danger">Remove</button>
                    </div>
                  </div>
                  </div>
                </div>
