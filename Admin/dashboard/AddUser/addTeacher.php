            ...
            <div class="card-body">
              <form method="POST" action="add_teacher_post.php">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="tc" id="input-username" class="form-control form-control-alternative" placeholder="T.C Number" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">University Number</label>
                        <input type="text" name="teacher_number" id="input-username" class="form-control form-control-alternative" placeholder="1511xxxxxxxx" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Faculty</label>
                        <input type="text" name="faculty" id="input-username" class="form-control form-control-alternative" placeholder="Faculty Name" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Department</label>
                        <input type="text" name="department" id="input-username" class="form-control form-control-alternative" placeholder="Department Name" required>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="email" name="email" id="input-email" class="form-control form-control-alternative" placeholder="exmple@gmail.com" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                        <button class="btn btn-primary" type="submit" name="add-teacher-btn">Add Teacher</button>
                    </div>
                  </div>
                </div>
              </form>
