            ...
            <div class="card-body">
              <form method="post" action="add_student_post.php">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="tc" class="form-control form-control-alternative" placeholder="1511XXXXXXX" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Nationality</label>
                        <input type="text" name="nationality" class="form-control form-control-alternative" placeholder="Turkey" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="university" class="form-control form-control-alternative" placeholder="University" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Faculty</label>
                        <input type="text" name="faculty" class="form-control form-control-alternative" placeholder="Faculty Name" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Department</label>
                        <input type="text" name="department" class="form-control form-control-alternative" placeholder="Department" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Grade</label>
                        <input type="text" name="grade" class="form-control form-control-alternative" placeholder="Grade ex: 2" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">University NO</label>
                        <input type="text" name="university_no" class="form-control form-control-alternative" placeholder="University NO" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                        <button name="add-student-btn" class="btn btn-primary" type="submit">Add Student</button>
                    </div>
                  </div>
                  </div>
                </div>
